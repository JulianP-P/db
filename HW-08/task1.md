...
|:-----------------|:-----------|:-------------|:-------|---------------|
|Производительность|2338        |6190          |4 GB    |4 GB           | 
...
```
PgTune не предложил никаких настроек для этого блока. По моему мнению, самые оптимальные параметры, те, которые предложены по умолчанию. Поэтому в таблицу сравнения попали парметры по умолчанию и параметры от Pgconfigurator.
При применении следующих настроек производительность практически не изменилась.
