...
synchronous_commit = off, tps = 3761.747381 
```
...
Таким образом при synchronous_commit=off меньше накладных расходов на ожидание фиксации транзакции (а запись на диск одна из самых затратных оппераций по времени)
...
Для включения контрольной суммы страницы потребовалось изменить docker-compose.yml
```
environment:
